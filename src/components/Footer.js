        ...
        return (
            <div>
                <div className='contact'>
                    <div>
                        <h3 style={{textAlign:'justify'}} className='text-light-blue'>Have a project you'd like to discuss? Feel free to contact me. Literally I'm seeking a chance to work with great people.😇 Write me a message:</h3>
                        <EmailForm/>
                    </div>
                    <div className='text-light-blue social'>
                        
                        <div style={{paddingLeft:'50px', paddingTop:'16px'}}>
                            <a href="https://github.com/Asif-Biswas" target="_blank" rel="noreferrer" style={{textDecoration:'none'}}><p className='hover-text-white pointer' style={{minWidth:'300px'}}><FaGithub style={{fontSize:'min(8vw,36px)', marginRight:'16px', marginBottom:'-8px'}}/> <span style={{fontSize:'min(5vw,28px)'}}>GITHUB</span></p></a>
